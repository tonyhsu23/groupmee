...
role :web, "groupmee.com"                          # Your HTTP server, Apache/etc
role :app, "groupmee.com"                         # This may be the same as your `Web` server
role :db,  "groupmee.com"   , :primary => true # This is where Rails migrations will run
